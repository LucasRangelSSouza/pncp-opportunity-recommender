...
The evaluation splits the release by time: the 831 notices published before 2025-01-06 form the history, and the 1,148 published on 2025-01-06 or 2025-01-07 are the candidates. The history is used only to count how often each buyer published in each category. This avoids a quiet form of leakage in which a ranker learns about the candidates from the candidates.
